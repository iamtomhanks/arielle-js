 ...
 */
export async function saveToJsonFile(filename, data, options = {}) {
    const { outputDir = '.', createDir = true, pretty = true } = options;
    try {
 ...
 */
export function generateTimestampFilename(prefix = 'output') {
    const now = new Date();
