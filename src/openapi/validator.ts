 ...
 */
export function validatePaths(spec: OpenAPISpec): void {
 ...
 */
export function validateReferences(spec: OpenAPISpec): void {
 ...
 * @throws {Error} If the specification is invalid
 */
export function validateFullOpenAPISpec(spec: unknown): OpenAPISpec {
